...
public extension UIImage {
    ...
    /**
     ...
     - returns: thumb image
     */
    func compress(type: WechatCompressType = .session) -> Data? {
...
extension UIImage {
    ...
    @discardableResult
    func saveToFile(path: URL, quality: CGFloat = 0.75, forceUpdate: Bool = true) -> Bool {
