...
@IBDesignable open class PinCodeTextField: UIView {
    ...
    @IBInspectable public var underlineHeight: CGFloat = 0
    ...
    @IBInspectable public var fontSize: CGFloat = 47 {
        didSet {
            font = font.withSize(fontSize)
        }
    }
    @IBInspectable public var textColor: UIColor = UIColor.tokBlack
    @IBInspectable public var placeholderColor: UIColor = UIColor.tokBlack.withAlphaComponent(0.2)
    ...
    @IBInspectable public var secureText: Bool = true
    ...
    public var font: UIFont = UIFont.systemFont(ofSize: 47)
