...
/**
 * generate local unique id: 41 bit unixtime(millisecond) + 12 rand numnber + 10 sequence number, sign bit is not use
 * 00000000000000000000000000000000000000000				000000000000		0000000000 
 */
