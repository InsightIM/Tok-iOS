...
typedef NS_ENUM(NSInteger, OCTToxMessageOfflineCmd) {
    ...
    OCTToxMessageOfflineCmdSendResponse,
...
typedef NS_ENUM(NSInteger, OCTToxGroupCmdType) {
    ...
    OCTToxGroupCmdTypeMessage,
    OCTToxGroupCmdTypeGetPeerlist,
    OCTToxGroupCmdTypePeerName,
    OCTToxGroupCmdTypePeerPK,
    OCTToxGroupCmdTypeGetTitle,
    OCTToxGroupCmdTypeSetTitle,
    OCTToxGroupCmdTypeLeave,
    OCTToxGroupCmdTypePushToken,
    
    OCTToxGroupCmdTypeCreateCB = 21,
    OCTToxGroupCmdTypeBeInvited = 22,
    OCTToxGroupCmdTypeReveivedMsg = 23,
    OCTToxGroupCmdTypePeerlist = 24,
//    OCTToxGroupCmdTypePeerName,
//    OCTToxGroupCmdTypePeerPublicKeyCB,
    OCTToxGroupCmdTypeTitle = 27,
    OCTToxGroupCmdTypeKickedout,
};
