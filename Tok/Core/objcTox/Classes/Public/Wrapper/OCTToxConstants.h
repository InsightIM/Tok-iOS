...
typedef int64_t OCTToxMessageId;
...
extern const NSUInteger kOCTToxMaxOfflineMessageLength;
...
typedef NS_ENUM(NSInteger, OCTToxMessageOfflineCmd) {
    OCTToxMessageOfflineCmdQueryRequest, // deprecated
    OCTToxMessageOfflineCmdQueryResponse, // deprecated
    OCTToxMessageOfflineCmdSend, // deprecated
    OCTToxMessageOfflineCmdSendResponse, // deprecated
    ...
    OCTToxMessageOfflineCmdFilePull,
    OCTToxMessageOfflineCmdFileCancel,
    OCTToxMessageOfflineCmdVersionInfoRequest,
    OCTToxMessageOfflineCmdVersionInfoResponse
};

typedef NS_ENUM(NSInteger, OCTToxGroupCmd) {
    OCTToxGroupCmdCreate = 0,
    OCTToxGroupCmdCreateResponse,
    OCTToxGroupCmdInvite,
    OCTToxGroupCmdInviteNotice,
    OCTToxGroupCmdGetPeerList, // deprecated, see OCTToxGroupCmdPeerList
    OCTToxGroupCmdGetPeerListResponse, // deprecated, see OCTToxGroupCmdPeerListResponse
    OCTToxGroupCmdSetTitle,
    OCTToxGroupCmdSetTitleNotice,
    OCTToxGroupCmdGetTitle,
    OCTToxGroupCmdGetTitleResponse,
    OCTToxGroupCmdLeave = 10,
    OCTToxGroupCmdLeaveNotice,
    OCTToxGroupCmdKickout,
    OCTToxGroupCmdKickoutNotice,
    OCTToxGroupCmdSetMute,
    OCTToxGroupCmdDissolve,
    OCTToxGroupCmdDissolveNotice,
    OCTToxGroupCmdErrorNotice,
    OCTToxGroupCmdInfo,
    OCTToxGroupCmdInfoResponse,
    OCTToxGroupCmdPeerList,
    OCTToxGroupCmdPeerListResponse,
    OCTToxGroupCmdSetRemark,
    OCTToxGroupCmdAcceptJoinRequest,
    OCTToxGroupCmdAcceptJoinResponse,
    OCTToxGroupCmdRecommend,
    OCTToxGroupCmdRecommendResponse,
    OCTToxGroupCmdMessage = 31,
    OCTToxGroupCmdMessageReadNotice,
    OCTToxGroupCmdMessagePull, // deprecated, see OCTToxGroupCmdPullRequest
    OCTToxGroupCmdMessagePullResponse, // deprecated, see OCTToxGroupCmdPullResponse
    OCTToxGroupCmdMessageDel,
    OCTToxGroupCmdFilePull,
    OCTToxGroupCmdFileCancel,
    OCTToxGroupCmdPullRequest,
    OCTToxGroupCmdPullResponse,
    OCTToxGroupCmdNodesFilePullRequest,
};

typedef NS_ENUM(NSInteger, OCTToxStrangerCmd) {
    OCTToxStrangerCmdGetList,
    OCTToxStrangerCmdGetListResponse,
    OCTToxStrangerCmdGetAvatar,
    OCTToxStrangerCmdSignature,
    OCTToxStrangerCmdSignatureResponse
};
