 ...
 * @param time 0 local time.
 */
- (void)tox:(OCTTox *)tox friendMessage:(NSData *)message type:(OCTToxMessageType)type friendNumber:(OCTToxFriendNumber)friendNumber time:(NSTimeInterval)time;
...
- (void)     tox:(OCTTox *)tox
      peerNumber:(NSUInteger)peerNumber
         cookie:(NSString *)cookie
          length:(NSInteger)length;

- (void)     tox:(OCTTox *)tox
      conferenceNumber:(OCTToxFileNumber)conferenceNumber
    peerNumber:(OCTToxFriendNumber)peerNumber
        message:(NSString *)message
            type:(OCTToxMessageType)type;

- (void)tox:(OCTTox *)tox cmdType:(OCTToxGroupCmdType)cmdType groupMessage:(NSData *)groupMessage length:(NSInteger)length;

- (void)tox:(OCTTox *)tox
receivedMessage:(NSData *)messageData
     length:(NSInteger)length
friendNumber:(OCTToxFriendNumber)friendNumber
       time:(NSTimeInterval)time;

- (void)tox:(OCTTox *)tox
receivedResponse:(NSData *)messageData
     length:(NSInteger)length
friendNumber:(OCTToxFriendNumber)friendNumber
       time:(NSTimeInterval)time;

- (void)tox:(OCTTox *)tox
receivedConfirm:(NSData *)messageData
     length:(NSInteger)length
friendNumber:(OCTToxFriendNumber)friendNumber
       time:(NSTimeInterval)time;
