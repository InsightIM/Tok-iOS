...
// */
//- (OCTToxMessageId)sendOfflineMessageWithFriendNumber:(OCTToxFriendNumber)friendNumber
//                                            botNumber:(OCTToxFriendNumber)botNumber
//                                              message:(NSString *)message
//                                                error:(NSError **)error;

/**
 * Send a text chat message to an online friend using the default protocol of tox.
 */
