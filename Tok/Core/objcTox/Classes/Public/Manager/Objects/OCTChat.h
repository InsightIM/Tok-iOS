...
/*
 * length is 20. eg. #1234567890123456789
 */
...
@property (nullable) NSString *groupDescription;

@property NSInteger groupMemebersCount;
/*
 * 0 private, 1 public
 */
@property NSInteger groupType;
...
@property (nullable) NSString *ownerPublicKey;
...
/* 0 normal/enabled, 1 removed, 2 dissolved */
@property NSInteger groupStatus;

@property long long lastMessageId;

@property NSInteger leftCount;
