...
@protocol OCTSubmanagerDataSource;
...
@protocol OCTManager <NSObject, OCTSubmanagerDataSource>
...
/**
 * Group Message Bot Public Key (long term public key) of kOCTToxPublicKeyLength.
 */
@property (strong, nonatomic, nullable) NSString *groupBotPublicKey;

/**
 * Find Stranger Message Bot Public Key (long term public key) of kOCTToxPublicKeyLength.
 */
@property (strong, nonatomic, nullable) NSString *strangerBotPublicKey;
