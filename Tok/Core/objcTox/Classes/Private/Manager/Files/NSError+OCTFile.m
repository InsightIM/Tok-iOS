...
+ (NSError *)sendFileErrorOfflineFileTooBig
{
    return [NSError errorWithDomain:kOCTManagerErrorDomain
                               code:OCTSendFileErrorOfflineFileTooBig
                           userInfo:@{
                                      NSLocalizedDescriptionKey : @"Send file",
                                      NSLocalizedFailureReasonErrorKey : @"Only offline files smaller than 10M are supported.",
                                      }];
}
...
+ (NSError *)sendFileErrorFromToxFileSendError:(OCTToxErrorFileSend)code
{
    switch (code) {
        ...
        case OCTToxErrorFileSendTooMany:
            ...
            case OCTSendFileErrorOfflineFileTooBig:
            return [self sendFileErrorOfflineFileTooBig];
    }
}
