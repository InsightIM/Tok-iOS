...
@interface OCTManagerImpl () <OCTToxDelegate>
...
@synthesize groupBotPublicKey = _groupBotPublicKey;
@synthesize strangerBotPublicKey = _strangerBotPublicKey;
...
{
    return self.groupBotPublicKey;
}

- (NSString *)getStrangerMessageBotPublicKey
{
    return self.strangerBotPublicKey;
}
...
- (id)forwardingTargetForSelector:(SEL)aSelector
{
    ...
    for (id delegate in submanagers) {
        if ([delegate respondsToSelector:aSelector]) {
            if ([delegate isKindOfClass:[OCTSubmanagerChatsImpl class]]) {
                return _delegate;
            }
            if ([delegate isKindOfClass:[OCTSubmanagerFilesImpl class]]) {
                return _delegate;
            }
            return delegate;
        }
