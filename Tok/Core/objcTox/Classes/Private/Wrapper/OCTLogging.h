...
#define OCTLogCCError(frmt, ...)   //NSLog(@"") //DDLogCError((frmt), ## __VA_ARGS__)
#define OCTLogCCWarn(frmt, ...)    //NSLog(@"") //DDLogCWarn((frmt), ## __VA_ARGS__)
#define OCTLogCCInfo(frmt, ...)    //NSLog(@"") //DDLogCInfo((frmt), ## __VA_ARGS__)
#define OCTLogCCDebug(frmt, ...)   //NSLog(@"") //DDLogCDebug((frmt), ## __VA_ARGS__)
#define OCTLogCCVerbose(frmt, ...) //NSLog(@"") //DDLogCVerbose((frmt), ## __VA_ARGS__)
